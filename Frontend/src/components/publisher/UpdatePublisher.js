...
class UpdatePublisher extends React.Component {
    ...
    updatePublisher = (e) => {
        ...
        PublisherService.updatePublisher(publisher).then( res => {
            ...
            alert("The publisher was successfully updated!");
        });
    } 
    ...
    render () {
        return (
            ...
            <div style={{"display":this.state.show ? "block" : "none"}}>
                <MyToast show = {this.state.show} message = {this.state.method === "put" ? "Publisher Updated Successfully." : "Publisher Saved Successfully."} type = {"success"}/>
            </div>
            <Card className={"border border-dark bg-dark text-white"}>
                <Card.Header>
                    <FontAwesomeIcon icon={faEdit} /> {"Update Publisher"}
                </Card.Header>
                <Form onReset={this.resetPublisher} onSubmit={this.updatePublisher} id="publisherFormId"> 
                    <Card.Body>
                        <Form.Row>
